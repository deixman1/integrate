...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL,"https://vk.com/dev?act=a_run_method&al=1&hash=1507140878:455736534f3fe7deba&method=video.get&param_extended=1&param_owner_id=".$_REQUEST['owner_id']."&param_v=5.68&param_videos=".$_REQUEST['videos']);
$headers = [
